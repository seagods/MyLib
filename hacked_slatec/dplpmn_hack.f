...
C
     ...
     *   (TOLABS,ROPT(7))
      ...
      integer NPR014
      integer NPR015
C     This is a hacked version of the slatec original
C     I have replaced all assign statements and assigned go to
C     statements
C
...
C     GO TO NPR005, (20018,20154,20243)
      ...
      if(NPR005.eq.20254)go to 20254
