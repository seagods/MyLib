...
C***END PROLOGUE  SPLPMU
     ...
     * COLNRM(*),RCOST,SASUM,SDOT
      ...
      integer NPR001
      integer NPR003
C     hacked version of original slatec
C     assign statements replaced
C
